...
//    BOOL _isRootScroll;                             //是否主视图滑动
    ...
    CGFloat _topScrollViewWidth;                    // 设置topScrollView的宽度
    CGFloat _topFontSizeOfTabButton;                // 设置topScrollView按钮文字字体大小
    UILabel *_bottomLine;
    CGFloat _topFontSizeOfTabButtonSelect;      //设置topScrollView 选中 按钮的文字大小
...
@property (nonatomic, assign) CGFloat topScrollViewWidth;
@property (nonatomic, assign) CGFloat topFontSizeOfTabButton;
@property (nonatomic,strong) NSArray *showMenuArr;

typedef void (^SelectMenuCompletionBlock)(NSInteger tag);
@property (nonatomic,strong)SelectMenuCompletionBlock  complettionBlock;
/*!
 * @method 创建子视图UI
 * @abstract
 * @discussion
